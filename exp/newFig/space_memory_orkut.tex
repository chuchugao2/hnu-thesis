...
% \fixNum
\begin{customlegend}[legend style={at={(3.55, 4.3) ,font=\ptfont{19pt}}, draw=none, row sep=-0.6pt, fill=none, anchor = north,inner sep = 0pt},legend columns = 2,legend cell align=left,legend entries={\rf,\cg}]
...
\begin{customlegend}[legend style={at={(2.85, 1.65) ,font=\ptfont{19pt}}, draw=none, row sep=-0.6pt, fill=none, anchor = north,inner sep = 0pt},legend columns = 2,legend cell align=left,legend entries={\itk,\pm}]
