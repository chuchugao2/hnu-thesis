...
\begin{customlegend}[legend style={at={(3.55, 2) ,font=\ptfont{16pt}}, draw=none, row sep=-0.6pt, fill=none, anchor = north,inner sep = 0pt},legend columns = 2,legend cell align=left,legend entries={\ctk,\gf,\rf,\cg}]
...
\begin{customlegend}[legend style={at={(2.55, 4.2) ,font=\ptfont{16pt}}, draw=none, row sep=-0.6pt, fill=none, anchor = north, inner sep = 0pt},legend columns = 2,legend cell align=left,legend entries={\itk,\pm}]
